...
Este projeto utiliza a linguagem de programação lógica **Prolog** para modelar e validar a consistência interna de dogmas da fé católica. O sistema verifica se uma verdade de fé possui fundamento (passagens bíblicas, tradição e axiomas) e se as objeções lógicas conhecidas foram devidamente resolvidas.

O objetivo principal é estudar e conhecer os dogmas da Igreja Católica, unindo esse estudo aos fundamentos da Programação Lógica. Trançando árvores de inferência lógicas, o sistema destrincha um dogma para mostrar as evidências fundamentais que o sustentam, onde nas folhas dessas árvores residem verdades irrefutáveis (axiomas).
...
Comandos básicos de exploração no Prolog:
```prolog
...
Deseja fazer uma sugestão, recomendação de conteúdo, alteração teológica/lógica ou contribuir com o projeto? 

- ✉️ **E-mail**: [joao30henrique@gmail.com](mailto:joao30henrique@gmail.com)
- 🐙 **GitHub**: [github.com/jhvlima/dogmaslogica](https://github.com/jhvlima/dogmaslogica)
